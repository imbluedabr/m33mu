...
# builds the wolfssl-simulators Cargo workspace and imports the three
# resulting static libraries as CMake IMPORTED targets.
#
# Usage (in CMakeLists.txt):
#
#   include(cmake/RustPlugin.cmake)
#   mm_rust_plugins_build()
#   target_link_libraries(m33mu_lib PUBLIC atecc608_sim se050_sim stsafe_a120_sim)
#
# Each IMPORTED target (atecc608_sim, se050_sim, stsafe_a120_sim) exposes its
# .a file; the caller must still add the Rust runtime link flags
# (-lpthread -ldl -lm) to the final executable or library target.
...
macro(mm_rust_plugins_build)
    # One custom command builds the entire workspace; all three .a files are
