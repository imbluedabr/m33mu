...
static struct serial_inst serials[7];
...
static mm_bool serial_read(void *opaque, mm_u32 offset, mm_u32 size_bytes, mm_u32 *value_out)
{
    ...
    if (offset == EVENTS_RXDRDY || offset == EVENTS_ENDRX || offset == EVENTS_TXDRDY ||
...
static void serial_register_all(struct mmio_bus *bus, struct mm_nvic *nvic)
{
    static const mm_u32 bases[] = {
        0x4004D000u, /* UARTE00 / SPIM00 */
        0x400C6000u, /* UARTE20 / SPIM20 */
        0x400C7000u, /* UARTE21 / SPIM21 */
        0x400C8000u, /* UARTE22 / SPIM22 */
        0x400ED000u, /* UARTE23 / SPIM23 */
        0x400EE000u, /* UARTE24 / SPIM24 */
        0x40104000u  /* UARTE30 / SPIM30 */
    };
    static const int irqs[] = { 77, 198, 199, 200, 237, 238, 260 };
    static const mm_bool has_uarte[] = { MM_TRUE, MM_TRUE, MM_TRUE, MM_TRUE, MM_TRUE, MM_TRUE, MM_TRUE };
