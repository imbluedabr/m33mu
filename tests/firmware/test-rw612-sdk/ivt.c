...
/* RW612: 16 core + up to 80 peripheral interrupts.  We size for 96 entries
 * which is plenty for the test surface and well under flash. */
__attribute__((section(".isr_vector")))
const uint32_t vector_table[16 + 80] = {
    [0]       = (uint32_t)&_estack,
