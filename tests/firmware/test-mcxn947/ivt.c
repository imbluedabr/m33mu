...
void GPIO0_INT0_IRQHandler(void)  __attribute__((weak, alias("default_handler")));
void GPIO0_INT1_IRQHandler(void)  __attribute__((weak, alias("default_handler")));

__attribute__((section(".isr_vector")))
const uint32_t vector_table[16 + 160] = {
    [0] = (uint32_t)&_estack,
    ...
    [16 + 17] = (uint32_t)&GPIO0_INT0_IRQHandler,
    [16 + 18] = (uint32_t)&GPIO0_INT1_IRQHandler,
    [16 + 143] = (uint32_t)&LPTMR0_IRQHandler
};
